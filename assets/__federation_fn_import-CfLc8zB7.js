...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BcUgTuUO.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BPiK34Ci.js', import.meta.url).href),import:true},'formik':{get:()=>()=>__federation_import(new URL('__federation_shared_formik-aqut38EQ.js', import.meta.url).href),import:true},'yup':{get:()=>()=>__federation_import(new URL('__federation_shared_yup-CYQUeFFj.js', import.meta.url).href),import:true},'axios':{get:()=>()=>__federation_import(new URL('__federation_shared_axios-yAO4E2yD.js', import.meta.url).href),import:true},'bootstrap':{get:()=>()=>__federation_import(new URL('__federation_shared_bootstrap-BJf3GMr-.js', import.meta.url).href),import:true}};
