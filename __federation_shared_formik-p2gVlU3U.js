import { importShared } from './__federation_fn_import-CTlbsFWL.js';
...
function connect(Comp) {
  var C = function C(props) {
    return createElement(FormikConsumer, null, function (formik) {
      !!!formik ? process.env.NODE_ENV !== "production" ? warning(false, "Formik context is undefined, please verify you are rendering <Form>, <Field>, <FastField>, <FieldArray>, or your custom context-using component as a child of a <Formik> component. Component name: " + Comp.name) : warning() : void 0;
...
var FastFieldInner = /*#__PURE__*/function (_React$Component) {
  ...
  function FastFieldInner(props) {
    ...
    var render = props.render,
        ...
        is = props.as,
        name = props.name;
    !!render ? process.env.NODE_ENV !== "production" ? warning(false, "<FastField render> has been deprecated. Please use a child callback function instead: <FastField name={" + name + "}>{props => ...}</FastField> instead.") : warning() : void 0;
    !!(component && render) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField component> and <FastField render> in the same <FastField> component; <FastField component> will be ignored') : warning() : void 0;
    !!(is && children && isFunction(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField as> and <FastField children> as a function in the same <FastField> component; <FastField as> will be ignored.') : warning() : void 0;
    !!(component && children && isFunction(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.') : warning() : void 0;
    !!(render && children && !isEmptyChildren(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField render> and <FastField children> in the same <FastField> component; <FastField children> will be ignored') : warning() : void 0;
    return _this;
  }
